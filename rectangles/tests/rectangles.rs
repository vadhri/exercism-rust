...
#[test]
#[ignore]
fn test_large_input_with_many_rectangles1() {
    let lines = &[
    "+---+--+----+",
    "|   +--+----+",
    "+---+--+    |",
    ];
    assert_eq!(7, count(lines))
}

#[test]
#[ignore]
fn test_large_input_with_many_rectangles2() {
    let lines = &[
    "+---+--+----+",
    "|   +--+----+",
    "+---+--+    |",
