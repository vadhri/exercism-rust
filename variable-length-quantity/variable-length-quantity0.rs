...
//     assert_eq!(&[0xff, 0x7f], vlq::to_bytes(&[0x3f, 0xff]).as_slice());
//     assert_eq!(&[0x81, 0x80, 0x00], vlq::to_bytes(&[0x40, 0x00]).as_slice());
//     assert_eq!(&[0xff, 0xff, 0x7f], vlq::to_bytes(&[0x1f, 0xff, 0xff]).as_slice());
//     assert_eq!(&[0x81, 0x80, 0x80, 0x00], vlq::to_bytes(&[0x00, 0x20, 0x00, 0x00]).as_slice());
//     assert_eq!(&[0xc0, 0x80, 0x80, 0x00], vlq::to_bytes(&[0x08, 0x00, 0x00, 0x00]).as_slice());
//     assert_eq!(&[0xff, 0xff, 0xff, 0x7f], vlq::to_bytes(&[0x0f, 0xff, 0xff, 0xff]).as_slice());
//
//     assert_eq!(
//         &[0x81, 0x80, 0x80, 0xc8, 0xe8, 0x56],
//         vlq::to_bytes(&[0x4000, 0x12_3456]).as_slice()
//     );
//
//     assert_eq!(
//         &[
//             0x82, 0x80, 0x82, 0xa3, 0xa2, 0xdb, 0xff, 0xff, 0xff, 0xfc, 0x81, 0xff, 0xff, 0x80,
//             0x00,
//         ],
